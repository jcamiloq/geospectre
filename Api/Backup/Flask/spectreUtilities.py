...
def makeImageW(ejeYMakeImage):
    ...
    plt.legend()
    rutaImagen= "D:/Tesis/Api/Flask/imagenEspectroW.png"
...
def makeImageD(ejeYMakeImage):
    ...
    ax.set_ylim(min(ejeY), max(ejeY))
    plt.legend()
    rutaImagen= "D:/Tesis/Api/Flask/imagenEspectroD.png"
    resultadoMakeImage= plt.savefig(rutaImagen, format="png")
    plt.cla()
    plt.clf()
    plt.close()
...
def makeImageC(ejeYMakeImage, j):
    ...
    plt.legend()
    rutaImagen= "D:/Tesis/Api/Flask/imagenEspectroC%s.png" %(str(datetime.datetime.now())[18:19])
    resultadoMakeImage= plt.savefig(rutaImagen, format="png")
    plt.cla()
    plt.clf()
    plt.close()
