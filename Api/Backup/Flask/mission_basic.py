...
def adds_square_mission(aLocation, aSize):
    ...
    cmds.add(Command( 0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 7, 0, 0, 0, point1.lat, point1.lon, 11))
    # cmds.add(Command(0,0,0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_CONDITION_DISTANCE, 0, 0, 15,0,0,0,0,0,0))
