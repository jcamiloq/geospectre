...
def initCon(alturaR, velocidadR):
    global altura, velocidad, vehicle, sitl
    altura = alturaR
...
def telem():
    ...
    if vehicle:
        ...
        if vehicle.armed:
            ...
            armado = "F"
    return vehicle.location.global_relative_frame, vehicle.attitude, vehicle.airspeed, vehicle.battery, senalCaptura, vehicle.commands.next, armado
